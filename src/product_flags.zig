...
/// Full source checkouts compile internal harness leaves; package extracts do not ship them.
pub const has_internal_harnesses = if (@hasDecl(build_options, "internal_harnesses"))
    build_options.internal_harnesses
else
    false;
